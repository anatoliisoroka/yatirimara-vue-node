   ...
   <div class="w-max-1000">
         ...
         <b-col cols="12" sm="6" md="4" class="mb-4">
            <b-form-group>
               ...
               <b-form-select
                  :options="
                     form.city
                        ? gsv(CitiesJson, [form.city, 'districts'], [])
                        : []
                  "
      ...
      <b-row>
         <b-col cols="12" sm="6" md="4" class="mb-4">
            <b-form-group>
               <slot name="label">
                  <k-label label="Investor MKK Number" msg="" />
               </slot>
               <b-form-input
                  v-model="form.MKK"
                  trim
                  placeholder="Investor MKK Number"
               ></b-form-input>
            </b-form-group>
         </b-col>
         <b-col cols="12" sm="6" md="4" class="mb-4">
            ...
            <b-form-group class="mb-3">
               <k-label label="Income statement" />
               <k-file1
                  v-model="form.income_statement_file"
                  :file1.sync="form.income_statement_url"
                  accept=".pdf"
               ></k-file1>
            </b-form-group>
         </b-col>
...
export default {
   ...
   data() {
      return {
         ...
         form: {
            ...
            MKK: this.$store.state.auth.user.MKK || "",
   ...
   methods: {
      ...
      hSubmitS() {
         ...
         let form = { ...this.form };
         if (!form.income_statement_file) delete form.income_statement_file;
   ...
   async mounted() {
      ...
      if (res) {
         ...
         this.form = { ...newform, income_statement_file: null };
      }
   },
};
</script>
